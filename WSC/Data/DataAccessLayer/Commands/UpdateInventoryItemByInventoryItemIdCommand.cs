...
{
    public class UpdateInventoryItemByInventoryItemIdCommand : ObjectCommand
    {
        ...
        public UpdateInventoryItemByInventoryItemIdCommand(SqlCommand sqlCommand)
            : base(sqlCommand)
        {
            Command.CommandText = "[dbo].[spUpdatetblInventoryItemByInventoryItemId]";
