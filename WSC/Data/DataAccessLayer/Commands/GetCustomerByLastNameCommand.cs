...
{
    public class GetCustomerByLastNameCommand : ObjectCommand
    {
        private readonly SqlParameter _returnValue;
        private readonly SqlParameter _personLastName;

        public GetCustomerByLastNameCommand(ObjectConnection objectConnection)
            : this(objectConnection.CreateCommand())
        {
        }

        public GetCustomerByLastNameCommand(SqlCommand sqlCommand)
            : base(sqlCommand)
        {
