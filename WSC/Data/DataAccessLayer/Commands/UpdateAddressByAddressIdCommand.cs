...
{
    public class UpdateAddressByAddressIdCommand : ObjectCommand
    {
        ...
        public UpdateAddressByAddressIdCommand(SqlCommand sqlCommand)
            : base(sqlCommand)
        {
            Command.CommandText = "[dbo].[spUpdatetblAddressByAddressId]";
